...
- [Ms2ex.GameHandlers.Helper.ItemBox](Ms2ex.GameHandlers.Helper.ItemBox.md)
...
- Contexts
  ...
  - [Ms2ex.Context.Inventory](Ms2ex.Context.Inventory.md): Context module for inventory-related operations.
