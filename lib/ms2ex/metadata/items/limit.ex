defmodule Ms2ex.Metadata.Items.Limit do
  @moduledoc false
  ...
  field :gender, 5, enum: true, type: Ms2ex.Metadata.Items.Gender
  field :transfer_type, 6, enum: true, type: Ms2ex.Metadata.Items.TransferType
