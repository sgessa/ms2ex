defmodule Ms2ex.Storage.Items.StaticOptions do
  @moduledoc false
  use Protobuf, syntax: :proto3

  alias Ms2ex.Metadata.Items

  field :items, 1, repeated: true, type: Items.StaticOptionId

  @table :item_static_option_metadata

  def store() do
    list =
      [:code.priv_dir(:ms2ex), "resources", "ms2-item-option-static-metadata"]
      |> Path.join()
      |> File.read!()
      |> __MODULE__.decode()
