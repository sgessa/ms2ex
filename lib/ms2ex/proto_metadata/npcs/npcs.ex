defmodule Ms2ex.ProtoMetadata.Npc do
  @moduledoc false
  ...
  # field :state_actions, 12, repeated: true, type: ProtoMetadata.NpcAction
  ...
  field :basic, 22, type: ProtoMetadata.NpcBasic
  field :combat, 23, type: ProtoMetadata.NpcCombat
  field :dead, 24, type: ProtoMetadata.NpcDead
  field :distance, 25, type: ProtoMetadata.NpcDistance
  field :interact, 26, type: ProtoMetadata.NpcInteract
  field :stats, 27, type: ProtoMetadata.NpcStats
  field :type, 28, type: :int32
  field :shop_id, 29, type: :int32
end

defmodule Ms2ex.ProtoMetadata.Npcs do
  @moduledoc false
  use Protobuf, syntax: :proto3

  alias Ms2ex.ProtoMetadata.Npc
