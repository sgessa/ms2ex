defmodule Ms2ex.ProtoMetadata.Items.Property do
  @moduledoc false
  use Protobuf, syntax: :proto3

  field :stack_limit, 1, type: :int32
  field :skin_type, 2, enum: true, type: Ms2ex.ProtoMetadata.Items.SkinType
  ...
  field :sell, 13, type: Ms2ex.ProtoMetadata.Items.Sell
end
