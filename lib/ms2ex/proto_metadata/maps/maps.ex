defmodule Ms2ex.ProtoMetadata.MapBlock do
  @moduledoc false
...
defmodule Ms2ex.ProtoMetadata.Map do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field :blocks, 4, repeated: true, type: Ms2ex.ProtoMetadata.MapBlock
end

defmodule Ms2ex.ProtoMetadata.Maps do
  @moduledoc false
  use Protobuf, syntax: :proto3

  field :items, 1, repeated: true, type: Ms2ex.ProtoMetadata.Map
